...
#include "iseg_hv_mpod.h"

//#ifdef __cplusplus
//extern "C" {
//#endif
#include "tcpip.h"  // $MIDASSYS/drivers/bus
#include "hv.h"  // $MIDASSYS/drivers/class
//#ifdef __cplusplus
//}
//#endif
...
const char *frontend_name = "feMpodHV";  // client name visible to other MIDAS clients
...
DEVICE_DRIVER d_drive_list[] = {
   {"MPODC", iseg_hv_mpod, NUM_CHANNELS, tcpip, DF_INPUT},
   {""}
};

EQUIPMENT equipment[] = {

   {"Wiener MPODC HV",                     // equipment name
      ...
      d_drive_list,             // device driver list
      NULL,                       // init string
   },
